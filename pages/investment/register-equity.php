...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($sanitisedInput) {
        $response = $equityService->RegisterEquity($sanitisedInput);
...
<html lang="en">
<head>
    <title>Register Equity | Pine</title>
    <meta charset="utf-8" />
...
-->
                ...
                <div class="row">
                    <div class="four columns">
                        ...
                        <input class="u-full-width" type="text" placeholder="Quantity" id="inputQuantity" name="quantity" value="0" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="four columns">
                        ...
                        <input class="u-full-width" type="text" placeholder="Buy price" id="inputBuyPrice" name="buy_price" value="0.00" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="four columns">
                        ...
                        <input class="u-full-width" type="text" placeholder="Current price" id="inputCurrentPrice" name="current_price" value="0.00" />
                    </div>
                </div>

                <div class="row">
                    <input class="button-primary" type="submit" value="Register Equity">
